...
import com.clinic.system.security.AppUserDetailsService;
import com.clinic.system.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/triage/**").hasAnyRole("ADMIN", "NURSE")
                        .requestMatchers("/api/doctor/**").hasAnyRole("ADMIN", "DOCTOR")
                        .requestMatchers("/api/lab/**").hasAnyRole("ADMIN", "LAB_TECH", "DOCTOR")
